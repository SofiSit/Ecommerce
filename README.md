Realizamos la logica de un ecommerce funcional con un grupo de 5 developers, el usuario tiene la posibilidad de autenticarse, agregar productor al carrito y realizar la compra.
